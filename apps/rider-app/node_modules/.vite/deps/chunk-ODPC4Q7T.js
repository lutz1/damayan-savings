...
var ThemeContext2 = React2.createContext(null);
if (true) {
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React9.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React9.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React9.useMemo(() => storageManager?.({
  ...
  const [isClient, setIsClient] = React9.useState(noSsr || !isMultiSchemes);
  React9.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React10.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React10.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React10.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme = React10.useMemo(() => {
...
//# sourceMappingURL=chunk-ODPC4Q7T.js.map
